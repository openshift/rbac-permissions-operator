...
```bash
# Check for known vulnerabilities in dependencies using govulncheck
# Install: go install golang.org/x/vuln/cmd/govulncheck@latest
govulncheck ./...

# Alternative: scan all dependencies
go list -json -m all | govulncheck -mode=modules -json -
```
...
- `controllers/subjectpermission/*_secret.go` (secret handling)

...
# Add rbac-permissions-operator role to the CSV:
...
csv['metadata']['name'] = "rbac-permissions-operator.v%s" % full_version
csv['spec']['version'] = full_version
csv['spec']['replaces'] = "rbac-permissions-operator.v%s" % prev_version
...
csv_filename = "rbac-permissions-operator.v%s.clusterserviceversion.yaml" % full_version

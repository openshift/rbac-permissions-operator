...
// GetOperatorNamespaceEnv retrieves the operator namespace from the running environment or error if unavailable
func GetOperatorNamespaceEnv() (string, error) {

...
// Source: sigs.k8s.io/controller-runtime/pkg/client (interfaces: Client,StatusWriter,Reader,Writer)
//
// Generated by this command:
//
//	mockgen -package client -destination=pkg/util/test/generated/mocks/client/cr-client.go sigs.k8s.io/controller-runtime/pkg/client Client,StatusWriter,Reader,Writer
//
